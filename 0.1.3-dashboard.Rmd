---
title: "Version 0.1.3: COVID dashboard"
output: 
...
### `r paste0("Worldwide confirmed cases as of ", WorldTSRecent$date)` 
...
# knitr::include_graphics(path = "figs/2020-07-11-geofacet-pos.png")
```
...
# knitr::include_graphics(path = "figs/2020-07-11-geofacet-cases.png")
```
...
# knitr::include_graphics(path = "figs/2020-07-11-geofacet-deaths.png")
```
