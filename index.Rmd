...
+ Changed contents of `valueBox()`s to sentence case  
+ Updated global maps with `orthographic` and `Mercator`  
...
```{r 2020-07-10-page01-tab01, echo=FALSE}
# knitr::include_graphics(path = "figs/2020-07-10-page01-tab01.png")
```
...
```{r 2020-07-10-page01-tab02, echo=FALSE}
# knitr::include_graphics(path = "figs/2020-07-10-page01-tab02.png")
```
...
### Column 4: Worldwide COVID-19 Cases (Cumulative) (`.tabset`)
...
## Page 3: United States COVID-19 Data
